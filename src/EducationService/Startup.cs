...
namespace LT.DigitalOffice.EducationService
{
  public class Startup : BaseApiInfo
  {
    ...
    private void ConfigureConsumers(IServiceCollectionBusConfigurator x)
    {
      ...
      x.AddConsumer<DisactivateUserEducationConsumer>();
    }
       ...
       RabbitMqConfig rabbitMqConfig)
    {
      ...
      cfg.ReceiveEndpoint(rabbitMqConfig.DisactivateUserEducationEndpoint, ep =>
      {
        ep.ConfigureConsumer<DisactivateUserEducationConsumer>(context);
      });
    }
    ...
    private void UpdateDatabase(IApplicationBuilder app)
    {
      ...
      using var context = serviceScope.ServiceProvider.GetService<EducationServiceDbContext>();
